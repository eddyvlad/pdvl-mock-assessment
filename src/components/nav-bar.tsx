      ...
      <div className="navbar flex items-center gap-3 px-1">
        ...
        <div className="ml-auto flex items-center gap-3 text-sm">
          ...
          <span className="hidden text-muted-foreground md:inline">
            by <Link href="https://eddyhidayat.com/?utm_source=pdvl-mock-assessment&utm_medium=referral&utm_campaign=site-attribution" target="_blank" rel="noreferrer" className="font-bold">eddyhidayat.com</Link>
          </span>
        </div>
      </div>
    </nav>
