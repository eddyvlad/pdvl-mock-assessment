...
- Implemented the standalone mockup at `docs/brand/mockups/steady-study.html`.
...
- Checked text pairings meet the 4.5:1 target. The minimum checked ratio is 5.64:1 for clay on the ivory surface.
